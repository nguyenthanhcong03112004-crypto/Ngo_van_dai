...
{
    private string $apiBase = 'http://localhost/backend/public/api';
    ...
    protected function setUp(): void
    {
        ...
        if (isset($response['data']['token'])) {
            ...
            $this->markTestSkipped('Cannot obtain admin token — is the API server running?');
        }
    }
    ...
    {
        // Arrange
        $credentials = ['email' => 'user@shop.com', 'password' => 'User@123'];
